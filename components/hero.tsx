...
export default function Hero (){
    ...
    return(
        ...
        <section className="mt-20 flex flex-col items-center w-full justify-center space-y-10 ">
            ...
            "><strong className="text-green " id="slong">Win your dream job </strong>with <strong className="shadow-sm shadow-grey px-1 rounded-lg pl-2 pr-2">PostJob</strong></h1>
